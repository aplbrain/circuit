...
We plan to provide a $6,000 stipend for the core summer program and an additional $2,000 student stipend (and research credit) for each of the fall and spring terms (to be finalized).
...
Following the summer work, the school year work will consist of a hybrid model of independent study, and project meetings at JHU/APL. Students are responsible for their transportation, but we will help with carpooling coordination and your stipend will be sufficient to cover these expenses.

Will Gray-Roncal is teaching an intersession class this winter called Introduction to Connectomics!  While you will not be disadvantaged if you choose not to participate, it is a great way to learn about us and help us get to know you outside of a formal interview environment!

## Who Should Apply?

All students affiliated with Johns Hopkins University are invited to apply! Students do not need a background in computer science or engineering. However, students should be able to demonstrate a commitment to science and inquiry in their application. Examples of majors include but are not limited to: Chemical and Biomolecular Engineering, Biomedical Engineering, Computer Science, Computer Engineering, Mechanical Engineering, Electrical Engineering, Neuroscience, Biology, Molecular and Cellular Biology, and Applied Mathematics & Statistics. There is no minimum GPA requirement or major to apply.
...
We are looking for a few graduate students able to serve as teaching assistants; if you are interested in this role, please fill out the application and indicate in your essays.
...
Our positions will be filled quickly, so please apply early!!
...
-	May 20th: Full-time CIRCUIT begins
